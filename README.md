...
## 📸 界面截图
*(请在这里替换为你最新的 v1.2 版本宽屏界面截图)*

<img width="1280" height="720" alt="v1.2全新UI界面" src="在此插入你的新截图链接" />

*(请在这里替换为新版无边框快捷键弹窗的截图)*
<img width="480" height="360" alt="首次运行引导弹窗" src="在此插入你的新截图链接" />
